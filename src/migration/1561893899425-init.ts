...
export class init1561893899425 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<any> {
    await queryRunner.query("CREATE TABLE `restaurant` (`id` int NOT NULL AUTO_INCREMENT, `name` varchar(64) NOT NULL, `scheduleRAW` varchar(255) NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
